...
@class Main_ipadViewController;

@protocol VollyballMainViewControllerDelegate <NSObject>

- (void)gameViewController:(Main_ipadViewController *)controller didQuitWithReason:(QuitReason)reason;

@end

@interface Main_ipadViewController: UIViewController <iCarouselDataSource, iCarouselDelegate, UIActionSheetDelegate, UITextFieldDelegate, AVAudioPlayerDelegate, ADBannerViewDelegate, RevMobAdsDelegate, GameDelegate,GADInterstitialDelegate, VollyballMainSettingDelegate, UIWebViewDelegate>  {
    ...
    UIButton *Theme3ResetNew;
    UIButton *Theme3SettingNEW;
...
@property (nonatomic, assign) JDFlipAnimationType animationState;
