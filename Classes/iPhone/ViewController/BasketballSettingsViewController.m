//
//  BasketballSettingsViewController.m
//  Scoreboard
//
...
@implementation BasketballSettingsViewController
...
@synthesize m_pVolleyViewController;
...
- (void)viewDidLoad {
    ...
    UIImageView *BackGround=[[UIImageView alloc]initWithImage:[UIImage imageNamed:@"digitalSettingsBackground-4.jpg"]];
    
    [BackGround setFrame:CGRectMake(0, 0, 480, 320)];
    [self.view addSubview:BackGround];
    
    
    CGRect themeTrailposition = CGRectMake( 315, 70, 123, 163);
    ...
    if (ThemeColour==1) {
        ...
        [ThemeTrailsImageView setImage:[UIImage imageNamed:@"dot-0.png"]];
    ...
    [timePicker setFrame: CGRectMake(36, 70, 227, 50)];
    ...
    CGRect labelFrameSet = CGRectMake( 28, 28, 100, 40 );
    ...
    CGRect labelFrameMin = CGRectMake( 133, 28, 45, 40 );
    ...
    CGRect labelFrameA = CGRectMake( 167, 32, 5, 30 );
    ...
    CGRect labelFrameSec = CGRectMake( 172, 28, 60, 40 );
    ...
    homeButton.frame = CGRectMake(420, 280,45, 35);
    ...
    backbutton.frame=CGRectMake(360, 280,35, 35);
...
//    UIView *superView = self.parentViewController.view;
    ...
    [m_pVolleyViewController viewWillAppear:YES];
