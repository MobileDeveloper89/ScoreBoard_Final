...
@interface VolleyBallViewControllerBigger: UIViewController <UIActionSheetDelegate,UITextFieldDelegate,AVAudioPlayerDelegate,ADBannerViewDelegate>  {
    ...
    ADBannerView *adView;
    int PageNumber;
    UIButton *CustonPeriodbutton;
    UIButton *regulerSBButton;

    UIView *Tutorial;
    UIImageView *TutorialBackground;
