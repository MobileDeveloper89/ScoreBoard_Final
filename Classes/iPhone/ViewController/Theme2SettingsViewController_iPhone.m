//
//  Theme2SettingsViewController_iPhone.m
//  Scoreboard
//
...
@interface Theme2SettingsViewController_iPhone ()

@end

@implementation Theme2SettingsViewController_iPhone
...
- (void)viewDidLoad
{
   ...
   forControlEvents:UIControlEventTouchUpInside];
    ...
    CGRect themeTrailposition = CGRectMake( 307, 84, 90, 130);
    ...
    CGRect themeTrailpositionguest = CGRectMake( 85, 84, 90, 130);
