//
//  Theme1SettingViewController_iPhone.m
//  Scoreboard
//
...
@interface Theme1SettingViewController_iPhone ()

@end
static BOOL secSelected=0,minSelected=0;

@implementation Theme1SettingViewController_iPhone
...
- (void)viewDidLoad
{
    ...
    CGRect labelFrameSec = CGRectMake( 173, 28, 60, 40 );
