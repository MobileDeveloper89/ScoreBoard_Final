...
@class VollyballMainViewController;
...
@interface VollyballMainViewController: UIViewController <iCarouselDataSource, iCarouselDelegate, UIActionSheetDelegate, UITextFieldDelegate, AVAudioPlayerDelegate, ADBannerViewDelegate, RevMobAdsDelegate, GameDelegate, VollyballMainSettingDelegate, UIWebViewDelegate, GADBannerViewDelegate>  {
    ...
    UIButton *button1;
    UIButton *button2;
    UIButton *button3;   // VolleyBall Setting Button
...
@property(nonatomic, retain) IBOutlet UIView *m_pMainView;
