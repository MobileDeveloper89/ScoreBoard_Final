//
//  BasketballMainViewController_iPad.m
//  Scoreboard
//
...
#define MOVE_RANGE 488

@implementation BasketballMainViewController_iPad
...
- (void)viewDidLoad {
    ...
    //scrollView = [[UIScrollView alloc] initWithFrame:CGRectMake(-241, 0, 960, 320)];
    //scrollView.contentSize = CGSizeMake(480, 320);
    scrollView = [[UIScrollView alloc] initWithFrame:CGRectMake(-513, 0,2048, 748)];
    scrollView.contentSize = CGSizeMake(1024, 748);
    scrollView.showsHorizontalScrollIndicator = YES;
    [self.view addSubview:scrollView];
    
    countdownTimerView=[[CountdownTimer_iPad alloc]initWithFrame:CGRectMake(183, 6, 113, 61)];
    
    hiddenHomeTextField = [[UITextField alloc] initWithFrame:CGRectMake(70, 650, 320, 50)];
    hiddenHomeTextField.borderStyle = UITextBorderStyleBezel;
    hiddenHomeTextField.textColor = [UIColor whiteColor];
    ...
    hiddenHomeTextField.backgroundColor = [UIColor blackColor];
    ...
    guestTextField = [[UITextField alloc] initWithFrame:CGRectMake(570, 650, 320, 50)];
    guestTextField.borderStyle = UITextBorderStyleBezel;
    guestTextField.textColor = [UIColor whiteColor];
    ...
    guestTextField.backgroundColor = [UIColor blackColor];
    ...
    homeTextField = [[UITextField alloc] initWithFrame:CGRectMake(1070, 650, 320, 50)];
    homeTextField.borderStyle = UITextBorderStyleBezel;
    homeTextField.textColor = [UIColor whiteColor];
    ...
    homeTextField.backgroundColor = [UIColor blackColor];
    ...
    hiddenGuestTextField = [[UITextField alloc] initWithFrame:CGRectMake(1570, 650, 320, 50)];
    ...
    hiddenGuestTextField.backgroundColor = [UIColor blackColor];
    ...
    //CGRect myImageRect = CGRectMake( 228, 10, 15, 50);
    CGRect myImageRect1 = CGRectMake( 443, 10, 52, 150);
    ...
    CGRect myImageRect2 = CGRectMake( 390, 10, 52, 150);
    ...
    CGRect myImageRect3 = CGRectMake( 526, 10, 52, 150);
    ...
    CGRect myImageRect4 = CGRectMake( 579, 10, 52, 150);
    ...
    timerPlayandPauseButton.frame = CGRectMake(475, 170, 70, 100);
    ...
    backButton.frame = CGRectMake(460, 400, 100, 100);
    ...
    resetButton.frame = CGRectMake(490, 480, 40, 40);
    ...
    settingButton.frame = CGRectMake(460, 500, 100, 100);
   ...
   // CGRect myImageRect5 = CGRectMake( 239, 55, 144, 214);
     CGRect myImageRect5 = CGRectMake(10, 150, 300, 450);
    hiddenLeftHomeImageView = [[UIImageView alloc]initWithFrame:myImageRect5];
    [hiddenLeftHomeImageView setImage:[UIImage imageNamed:@"0ff.png"]];
    ...
    self.view.backgroundColor = [UIColor clearColor];
    CGRect myImageRect6 = CGRectMake( 220, 150, 300, 450);
    hiddenRightHomeImageView = [[UIImageView alloc]initWithFrame:myImageRect6];
    [hiddenRightHomeImageView setImage:[UIImage imageNamed:@"0ff.png"]];
    ...
    self.view.backgroundColor = [UIColor clearColor];
    CGRect myImageRect7 = CGRectMake(520, 150, 300, 450);
    ...
    self.view.backgroundColor = [UIColor clearColor];
    CGRect myImageRect8 = CGRectMake( 720, 150, 300, 450);
    ...
    self.view.backgroundColor = [UIColor clearColor];
    CGRect myImageRectd = CGRectMake( 1020, 150, 300, 450);
    ...
    self.view.backgroundColor = [UIColor clearColor];
    CGRect myImageRectc = CGRectMake(1220, 150, 300, 450);
    ...
    self.view.backgroundColor = [UIColor clearColor];
    CGRect myImageRectg = CGRectMake( 1520, 150, 300, 450);
   ...
   self.view.backgroundColor = [UIColor clearColor];
    CGRect myImageRecth = CGRectMake( 1720, 150, 300, 450);
