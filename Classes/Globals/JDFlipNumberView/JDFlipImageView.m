...
- (void)setImageAnimated:(UIImage*)image setFlip: (BOOL) isDownFlip;
{
    if (isDownFlip) {
        self.flipDirection = JDFlipImageViewFlipDirectionDown;
        [self setImageAnimated:image
                      duration:JDFlipImageViewFlipDirectionDown
                    completion:nil];
    } else {
        self.flipDirection = JDFlipImageViewFlipDirectionUp;
        [self setImageAnimated:image
                      duration:JDFlipImageViewFlipDirectionDown
                    completion:nil];
    }
...
//    if (self.flipDirection == JDFlipImageViewFlipDirectionDown) {
        self.topImageView.image = self.nextImages[0];
        self.bottomImageView.image = self.nextImages[1];
//    } else {
//        self.topImageView.image = self.nextImages[1];
//        self.bottomImageView.image = self.nextImages[0];
//    }
//        
...
//    BOOL isTopDown = (self.flipDirection == duration);
