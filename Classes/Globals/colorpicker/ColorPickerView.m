...
- (id)initWithCoder:(NSCoder*)coder  {
	if (self = [super initWithCoder:coder]) {
		...
		colorMatrixFrame = CGRectMake(20 * scoreboardWidthRate, 86 * scoreboardHeightRate, 165 * scoreboardWidthRate, 80 * scoreboardHeightRate);
...
//        [hueSatImage setImage:[UIImage imageNamed:@"home_color.jpg"]];
		[self addSubview:hueSatImage];
		[self sendSubviewToBack:hueSatImage];
		[hueSatImage release];
        
        colorGuestFrame = CGRectMake(20 * scoreboardWidthRate, 205 * scoreboardHeightRate, 165 * scoreboardWidthRate, 80 * scoreboardHeightRate);
...
//        [hueGuestImage setImage:[UIImage imageNamed:@"guest_color.jpg"]];
...
- (void)drawRect:(CGRect)rect {
    ...
    if (avalueforsettingtimer == 1)
    {
        [background setImage:[UIImage imageNamed:@"setting_2.jpg"]];
    } else {
        [background setImage:[UIImage imageNamed:@"setting_1.jpg"]];
    }
